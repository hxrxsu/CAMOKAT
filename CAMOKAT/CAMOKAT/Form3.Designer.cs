namespace Drinks
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            listBox2.Items.AddRange(new object[] { "Суп Самокат щавелевый с куриной грудкой", "Сэндвич-ролл Самокат с салатом цезарь", "Суп Самокат свекольник", "Блинчики Самокат с кремом и солёной карамелью" });
            listBox2.Location = new Point(-3, 329);
            ...
            label1.Location = new Point(282, 161);
            label1.Name = "label1";
            ...
            listBox1.Items.AddRange(new object[] { "Напиток растительный Самокат фундук", "Сок Самокат, манго, прямой отжим", "Квас Самокат, нефильтрованный", "Энергетик Самокат, с соком, маракуйя" });
            listBox1.Location = new Point(451, 329);
            ...
            label3.Location = new Point(59, 281);
            label3.Name = "label3";
            ...
            label4.Location = new Point(600, 281);
            label4.Name = "label4";
